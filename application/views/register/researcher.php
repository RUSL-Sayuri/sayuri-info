...
<div class="container">
  ...
  <option value="usa">USA</option>
                ...
                <div class="form-group">
					 <label for="confirmPassword1"><?php echo $common_label_15; ?></label><input type="password" class="form-control" id="exampleInputPassword1" />
				</div>
                
                
                
                <div class="form-group">
					 <label for="research_topic"><?php echo $researcher_label_1; ?></label><input type="text" class="form-control" id="research_topic" />
				</div>
                <div class="form-group">
					 <label for="university_institute"><?php echo $researcher_label_2; ?></label><input type="text" class="form-control" id="university_institute" />
				</div>
                <div class="form-group">
					 <label for="reserch_in_brief"><?php echo $researcher_label_3; ?></label><input type="textfield" class="form-control" id="reserch_in_brief" />
				</div>
                <div class="form-group">
					 <label for="inputFile"><?php echo $researcher_label_4; ?></label><input type="file" id="inputFile" />
