...
<div class="container">
  ...
  <option value="usa">USA</option>
                ...
                <div class="form-group">
					 <label for="designation"><?php echo $professional_label_1; ?></label><input type="text" class="form-control" id="designation" />
				</div>
                <div class="form-group">
					 <label for="working_place"><?php echo $professional_label_2; ?></label><input type="text" class="form-control" id="working_place" />
				</div>
                <div class="form-group">
					 <label for="specilalized_area"><?php echo $professional_label_3; ?></label><input type="textfield" class="form-control" id="specilalized_area" />
				</div>
